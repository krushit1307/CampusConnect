...
import { fetchEventsKeyset, CursorParams, FilterParams, extractCursorFromPage } from '../lib/supabase/keysetQueries';
...
export function useInfiniteEvents({
    ...
    return useInfiniteQuery({
        ...
        queryFn: async ({ pageParam = {} }) => {
            ...
            return fetchEventsKeyset(
                { ...pageParam, limit: pageSize, orderDirection },
                filters
            );
        },
