...
// sorted dynamically by upvotes in real-time, with swipe-to-dismiss played track actions.
// =============================================================================
...
export default function DJBoothDashboard() {
  ...
  const { requests, isLoading, dismissRequest } = useLiveDjRequests(activeEventId);
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mt-0.5">
              Crowd requests sorted in real-time by upvotes. Swipe or click to mark as played.
            </p>
          </div>
        </div>
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-slate-400 mt-0.5">{req.artist}</p>
                    </div>
                  </div>
