              ...
              >
                ...
                <div className="relative mx-auto flex max-w-xl flex-col items-center">
                  ...
                  <p className="mt-4 max-w-md font-mono text-sm leading-relaxed text-gray-700">
                    Share an announcement, ask a
                    question, or post an update for
                    your club community.
                  </p>
                  ...
                  <button
                    ...
                    className="neu-border mt-7 inline-flex items-center gap-2 bg-black px-5 py-3 font-mono text-xs font-bold uppercase text-cream transition-transform hover:-translate-y-0.5"
                  >
                    <PenLine
                      className="h-4 w-4"
                      aria-hidden="true"
