                ...
                <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-indigo-900 to-purple-900">
                    <div className="max-w-2xl text-center">
                        ...
                        <p className="text-2xl text-indigo-200 mb-12 leading-relaxed">
                            This mode will lock the browser into a full-screen scanning terminal.
                            Students can scan their QR codes for instant, hands-free check-in.
                        </p>
                        ...
                        >
                            {status === 'success' && (
                                <>
                                    ...
                                    <p className="text-5xl font-bold text-green-100">
                                        {result?.userName}
                                    </p>
                            ...
                            {status === 'already_checked_in' && (
                                <>
                                    <div className="w-48 h-48 bg-white rounded-full flex items-center justify-center mb-8 shadow-2xl">
                                        <svg className="w-32 h-32 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <p className="text-3xl text-yellow-200 mt-4">
                                        You're good to go!
                                    </p>
                                </>
                            )}
