...
export type EventChatMessagesQuery = { messages: Array<{ id: string, eventId: string, userId: string, content: string, createdAt: string, author: { id: string, full_name: string | null, handle: string | null } | null }> };
...
export type SendChatMessageMutation = { addMessage: { id: string, eventId: string, userId: string, content: string, createdAt: string, author: { id: string, full_name: string | null, handle: string | null } | null } };
...
export type MessageAddedSubscription = { messageAdded: { id: string, eventId: string, userId: string, content: string, createdAt: string, author: { id: string, full_name: string | null, handle: string | null } | null } };
...
export type GetEventsConnectionQuery = { events: { totalCount: number, edges: Array<{ cursor: string, node: { id: string, club_id: string, title: string, description: string | null, banner_url: string | null, event_date: string | null, start_date: string | null, end_date: string | null, location: string | null, created_by: string | null, created_at: string | null, is_private: boolean | null, club: { id: string, name: string | null } | null, organizer: { id: string, full_name: string | null, handle: string | null } | null } }>, nodes: Array<{ id: string, title: string }>, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } };
...
export type NotificationReceivedSubscription = { notificationReceived: { id: string, userId: string, type: NotificationType, title: string, message: string, link: string | null, isRead: boolean, createdAt: string, recentActors: Array<string> | null, groupCount: number | null, referenceId: string | null } };
