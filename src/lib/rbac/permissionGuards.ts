 ...
 */
export const PERMISSION_METADATA: Record<AppPermission, { label: string; description: string; category: string }> = {
    can_edit_profile: {
 ...
 */
export function hasAllPermissions(userPermissions: AppPermission[], required: AppPermission[]): boolean {
