...
import { Fingerprint, Key, Loader2, Plus, Trash2, Pencil, Check, X, ShieldCheck } from "lucide-react";
    ...
    if (!isSupported) {
        return (
            <div className="font-mono text-xs text-gray-500 dark:text-gray-300">
                <p>
                    Your browser does not support passkeys (WebAuthn). Use a modern
                    browser like Chrome, Safari, Edge, or Firefox to manage passkeys.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-4">
            ...
            {isLoadingPasskeys ? (
                ...
                <div className="border-2 border-dashed border-black/30 p-4">
                    <p className="font-mono text-xs text-gray-500 dark:text-gray-300">
                        No passkeys registered yet. Add one below to enable passwordless
                        sign-in.
                    </p>
                </div>
            ) : (
            ...
            <div className="border-t-2 border-black pt-4">
                <p className="eyebrow mb-2 font-bold text-black dark:text-cream">
                    Add a new passkey
                </p>
