        ...
        <div className="space-y-8">
            ...
            {!roiData.isAnonymous && (
                <div className="p-4 bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-500 rounded-r-lg flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="font-bold text-amber-800 dark:text-amber-300">Privacy Protection Active</h3>
                        <p className="text-sm text-amber-700 dark:text-amber-400 mt-1">
                            {roiData.message || 'Not enough data to ensure anonymity. Minimum 10 attendees required to display demographic charts.'}
                        </p>
                ...
                <>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Total Reach</p>
                            <p className="text-4xl font-black text-indigo-600 dark:text-indigo-400 mt-2">
                                {roiData.totalRsvps}
                            </p>
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Confirmed Attendees</p>
                        </div>

                        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Majors Reached</p>
                            <p className="text-4xl font-black text-purple-600 dark:text-purple-400 mt-2">
                                {roiData.majors?.length || 0}
                            </p>
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Distinct Fields of Study</p>
                        </div>

                        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Data Privacy</p>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">k-Anonymity Enforced</p>
                        </div>
                    </div>
