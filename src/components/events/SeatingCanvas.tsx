...
interface SeatingCanvasProps {
    ...
    onAssignSeat: (chairId: string, tableId: string, userId: string | null, userName: string | null) => void;
                ...
                <g transform={`translate(${pan.x}, ${pan.y}) scale(${zoom})`}>
                    ...
                    <defs>
                        <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
                            <path d="M 40 0 L 0 0 0 40" fill="none" stroke="currentColor" className="text-gray-200 dark:text-gray-800" strokeWidth="1" />
                        </pattern>
                    </defs>
                    ...
                    {tables.map(table => (
                        <g key={table.id} transform={`translate(${table.x}, ${table.y})`}>
                            ...
                            >
                                ...
                                <path d="M-3-3 L3 3 M3-3 L-3 3" stroke="white" strokeWidth="2" strokeLinecap="round" />
                            </g>
