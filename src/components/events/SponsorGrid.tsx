        ...
        switch (tier) {
            case 'platinum':
                return {
                    ...
                    height: 'h-40 md:h-48',
                    badgeColor: 'bg-slate-200 text-slate-800 dark:bg-slate-700 dark:text-slate-200 border-slate-300 dark:border-slate-600',
            ...
            case 'gold':
                return {
                    ...
                    height: 'h-32 md:h-40',
                    badgeColor: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400 border-yellow-200 dark:border-yellow-800',
            ...
            case 'silver':
                return {
                    ...
                    height: 'h-24 md:h-32',
                    badgeColor: 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300 border-gray-200 dark:border-gray-700',
            ...
            case 'bronze':
                return {
                    ...
                    height: 'h-20 md:h-24',
                    badgeColor: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400 border-orange-200 dark:border-orange-800',
        ...
        return (
            <div className="mb-12 last:mb-0">
                <div className="flex items-center gap-3 mb-6">
                    <h3 className={`text-xl font-bold ${config.accentColor}`}>
                        {config.title}
                    </h3>
...
const SponsorCard: React.FC<SponsorCardProps> = ({
    ...
    const wrapperProps = sponsor.website_url && !isEditMode
