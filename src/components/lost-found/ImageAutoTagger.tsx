...
export function ImageAutoTagger({
    onTagsChange,
    onPiiDetected,
    onClear,
}: ImageAutoTaggerProps) {
        ...
        async (file: File) => {
            ...
            if (result.result.hasPii) {
                setStatus({
                    kind: "pii_rejected",
                    reason:
                        result.result.piiReason ??
                        "Sensitive information detected in the image.",
                    previewUrl,
                });
                    ...
                    <div className="flex items-start gap-3 bg-red-50 p-4 dark:bg-red-950/40">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="mt-2 text-xs text-red-600 dark:text-red-400">
                                Please blur or crop out the sensitive information and
                                re-upload the image. Items containing personal data
                                cannot be posted.
                            </p>
                        </div>
                    </div>
                ...
                <div className="overflow-hidden rounded-lg border border-slate-200 dark:border-slate-700">
                    ...
                    <div className="p-4">
                        ...
                        <p className="mt-3 text-xs text-slate-400">
                            Review the tags above. Click × to remove any incorrect tags
                            before submitting.
                        </p>
