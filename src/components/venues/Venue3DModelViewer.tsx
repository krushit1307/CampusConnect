...
import { Box, Eye, Move, RotateCw, Layers, Plus, Trash2, CheckCircle2, AlertCircle } from "lucide-react";
import {
  SpatialItem,
  isValid3DModelUrl,
  ...
  return (
    <div className={cn("border-2 border-black rounded-xl bg-white overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] font-mono", className)}>
      ...
      <div className="relative h-[480px] bg-slate-950 text-white overflow-hidden flex items-center justify-center select-none">
        ...
        {activeTab === "3d" ? (
          <div data-testid="webgl-canvas-viewport" className="w-full h-full relative flex items-center justify-center bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-950">
            {/* Grid Floor Mesh */}
            <div
          ...
          /* 2D Floorplan View */
          <div data-testid="2d-floorplan-viewport" className="w-full h-full bg-slate-900 p-8 flex flex-col items-center justify-center space-y-4">
      ...
      {/* Spatial Controls & Table Quantity Simulator (#3447) */}
