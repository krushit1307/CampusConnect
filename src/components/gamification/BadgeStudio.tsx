    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-4">
                ...
                <Input placeholder="Badge title (e.g. Campus Legend)" value={title} onChange={(e) => setTitle(e.target.value)} />
                ...
                <div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                            {badges.map((badge) => (
                                <div key={badge.id} className="border-2 border-black p-3 flex flex-col items-center gap-2">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button variant="outline" size="sm" onClick={() => deleteBadge.mutate(badge.id)}>
                                            <Trash2 size={14} />
                                        </Button>
                                    </div>
                                </div>
