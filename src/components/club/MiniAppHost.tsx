...
export const MiniAppHost: React.FC<MiniAppHostProps> = ({
    clubId,
    clubName,
    remoteUrl
}) => {
        ...
        return (
            <div className="w-full bg-gray-50 dark:bg-gray-800/50 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-12 text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                    {clubName} hasn't deployed a custom micro-frontend yet.
                    Club admins can configure a remote URL in the developer settings to inject custom tools here.
                </p>
            </div>
        );
    }
