...
export const EventScheduler: React.FC<EventSchedulerProps> = ({
  ...
  return (
    <div className="border rounded-lg overflow-hidden bg-background shadow-sm" data-testid="event-scheduler">
      ...
      <div className="grid grid-cols-8 border-b bg-muted/10">
        ...
        {weekDays.map((day) => (
          <div key={day.toISOString()} className="p-2 text-xs font-medium text-center border-r last:border-r-0">
      ...
      <div className="grid grid-cols-8 max-h-[600px] overflow-y-auto relative">
        <div className="col-span-1 border-r">
          {hours.map((h) => (
            <div key={h} className="h-16 border-b p-2 text-xs text-muted-foreground flex items-start">
