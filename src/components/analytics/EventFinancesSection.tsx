    ...
    <div className="neu-border bg-white p-6 mt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-green-50 p-4 neu-border flex flex-col justify-center items-center text-center">
          <h3 className="font-bold text-lg font-mono uppercase text-green-800">Event P&L Summary</h3>
          ...
          <p className="text-xs mt-4 text-gray-500 font-mono">* This section will be included in the PDF export.</p>
        </div>
      </div>
    </div>
  );
