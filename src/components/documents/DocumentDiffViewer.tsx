                    ...
                    `}
                                    >
                                        ...
                                        <td className="w-8 px-3 py-1 text-center select-none">
                                            ...
                                            {line.type === 'removed' && <span className="text-red-600 dark:text-red-400 font-bold">-</span>}
                                        </td>
...
function computeLineDiff(oldText: string, newText: string): DiffLine[] {
    ...
    while (i > 0 || j > 0) {
        if (i > 0 && j > 0 && oldLines[i - 1] === newLines[j - 1]) {
            tempResult.unshift({ type: 'unchanged', content: oldLines[i - 1], oldLineNum: i, newLineNum: j });
            i--; j--;
