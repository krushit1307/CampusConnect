        ...
        return (
            <div className="my-6 p-6 bg-gray-50 dark:bg-gray-800/50 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl">
                ...
                <div className="space-y-2">
                    {options.map((opt, i) => (
                        <div key={i} className="px-4 py-3 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-200 font-medium">
                            {opt}
                        </div>
                    ))}
                </div>
            ...
            <div className="space-y-3">
              ...
              `}
                        >
                            ...
                            {hasVoted && (
                                <div
                                    className={`absolute inset-y-0 left-0 transition-all duration-700 ease-out ${isSelected
