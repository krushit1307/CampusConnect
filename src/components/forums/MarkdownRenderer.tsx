...
export const MarkdownRenderer: React.FC<MarkdownRendererProps> = ({ content, postId }) => {
    ...
    const components = {
        ...
        blockquote: ({ node, ...props }) => (
            <blockquote className="border-l-4 border-indigo-500 dark:border-indigo-400 pl-4 py-2 my-4 bg-gray-50 dark:bg-gray-800/50 italic text-gray-600 dark:text-gray-400" {...props} />
        )
    };
    ...
    return (
        <div className="prose prose-gray dark:prose-invert max-w-none">
            <ReactMarkdown
                remarkPlugins={[remarkGfm, remarkPollPlugin]}
