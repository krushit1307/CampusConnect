...
export declare const eventFormSchema: z.ZodEffects<z.ZodObject<{
    title: z.ZodString;
    ...
    faqs: z.ZodDefault<z.ZodOptional<z.ZodArray<z.ZodObject<{
 ...
 */
export declare function formatEventDateRange(startIso: string, endIso: string, timeZone?: string): string;
...
export declare function matchesDateFilter(dateStr: string | null | undefined, filterType: "all" | "this-week" | "next-month" | "specific", specificDate?: Date, now?: Date): boolean;
