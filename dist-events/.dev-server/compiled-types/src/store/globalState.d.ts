...
export declare const userSignal: import("../lib/signals").SignalGetter<UserProfile | null>, setUserSignal: import("../lib/signals").SignalSetter<UserProfile | null>;
export declare const themeSignal: import("../lib/signals").SignalGetter<"light" | "dark" | "system">, setThemeSignal: import("../lib/signals").SignalSetter<"light" | "dark" | "system">;
export declare const notificationsCountSignal: import("../lib/signals").SignalGetter<number>, setNotificationsCountSignal: import("../lib/signals").SignalSetter<number>;
export declare const unreadMessagesCountSignal: import("../lib/signals").SignalGetter<number>, setUnreadMessagesCountSignal: import("../lib/signals").SignalSetter<number>;
export declare const activeTabSignal: import("../lib/signals").SignalGetter<string>, setActiveTabSignal: import("../lib/signals").SignalSetter<string>;
