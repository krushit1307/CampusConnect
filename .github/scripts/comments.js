  ...
  successfulClaim: ({ user, issueNumber }) =>
    withMarker(
      ...
      `Hey @${user}, awesome to have you on board for this! 🚀\n\n` +
        ...
        `⏳ Try to open a PR within **30 hours**. If you need extra time, just drop a quick progress update here and you can keep going.\n\n` +
  ...
  manualAssignmentWelcome: ({ assignee, issueNumber }) =>
    withMarker(
      ...
      `Hi @${assignee}, welcome aboard! 🎉\n\n` +
        `You are now assigned to issue #${issueNumber}. Please follow **CONTRIBUTING.md**, keep your PR focused on this issue, and aim to open it within **30 hours**.\n\n` +
  ...
  expiration24h: ({ assignee }) =>
    withMarker(
      ...
      `Hi @${assignee}, thank you again for your interest in this issue! 🙏\n\n` +
        `Since there was no activity within the **30-hour** claim window, the issue has been released so other contributors can get a chance to work on it.\n\n` +
